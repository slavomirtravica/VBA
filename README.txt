...
This is macro/Sub/soon to be function for icreasing alphanumeric charaters.
Alphabet goes from 0 to 9 and than A to Z - so first "letter" is 0 and last one is Z.
Capital letters stay capital (except for 
...
Untill I turn it into function you have to put your code in A2 and under. You can override code by replacing A with new input column,
